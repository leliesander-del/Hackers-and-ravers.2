...
const tabs = [
  ...
  { to: '/kaart', label: 'Kaart', icon: 'M12 21s7-6.5 7-11a7 7 0 1 0-14 0c0 4.5 7 11 7 11Zm0-8.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z' },
      ...
      <div className="flex items-stretch justify-around px-2 py-2">
        {tabs.map((t) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `relative flex flex-1 flex-col items-center gap-1 rounded-lg py-1 text-[11px] font-medium transition ${
